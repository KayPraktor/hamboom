...
### ✅ پیامک: سیم‌کشی شد (۱۴۰۵/۰۶/۱۸) — و گیتِ launch باز شد
  ...
  **sms.ir** با قالبِ `#CODE#` و شناسه‌ی `265541`.
  ...
  ⏳ **تنها چیزِ مانده: تاییدِ روی گوشیِ واقعی** (`pnpm sms:probe`). دو چیز را هیچ تستی
  نمی‌گیرد: پیامک **رسید**؟ و ★★ جای کد **پر** است؟ (یک حرف اختلاف در نامِ پارامتر ⇒
  پیامکِ بی‌کد.) ⚠️ و متنِ قالبِ فعلی «این یک پیام تست…» است — نسخه‌ی تولیدی باید جدا
  تایید شود.
