...
- **گام بعدی:** ۴٫۲ — چرخه‌ی عمرِ اتاق. **فازهای ۰ تا ۳ کامل‌اند و گام ۴٫۱ هم تمام است:**
  سرورِ `ws` بالا می‌آید، توکن را از پشتِ پورتِ `BoardAuthority` می‌سنجد، و اتصالِ
  نامعتبر را **قبل از رسیدن به اتاق** با `HB_ERROR` و کدِ درست رد می‌کند.
