...
## ★★ فاز ۸ (`apps/web`) — ✅ **۸٫۱–۸٫۴ اثبات‌شده** (۱۴۰۵/۰۶/۱۰)
...
**مانده:** ۸٫۳ فولدر/سطلِ بازیافت · ۸٫۴ E2Eِ وبِ viewer + emitِ زنده‌ی میان‌درگ · **۸٫۵ سه یافته‌ی M2 (تاییدِ مالک)**.
**قدمِ بعد:** با مالک — فولدر/سطل، یا E2Eِ viewer، یا ۸٫۵.
