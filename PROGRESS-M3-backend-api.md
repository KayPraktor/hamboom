...
## ★★ فاز ۸ (`apps/web`) — ✅ **۸٫۱–۸٫۴ کامل + فولدر/سطلِ ۸٫۳ اثبات‌شده** (۱۴۰۵/۰۶/۱۰)
...
**مانده در فاز ۸:** فقط **۸٫۵ سه یافته‌ی M2** — ⚠️ هر سه `[!]`، تک‌تک تاییدِ مالک می‌خواهند (لمسِ M1/M2).
**قدمِ بعد:** با مالک — ۸٫۵ (یافته‌ها یکی‌یکی)، بعد فاز ۹ (نوار ابزار).
