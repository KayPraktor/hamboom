...
## ★★ فاز ۸ (`apps/web`) — ✅ **۸٫۱–۸٫۴ + فولدر/سطلِ ۸٫۳ اثبات‌شده** (۱۴۰۵/۰۶/۱۰)
...
**مانده:** ۸٫۴ E2Eِ وبِ viewer + emitِ زنده‌ی میان‌درگ · **۸٫۵ سه یافته‌ی M2 (تاییدِ مالک)**.
**قدمِ بعد:** با مالک — E2Eِ viewer/emitِ زنده، یا ۸٫۵ (یافته‌ها تک‌تک تایید می‌شوند).
