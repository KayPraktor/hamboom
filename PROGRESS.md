...
**گام فعلی: کلِ فاز ۰ تمام شد ✅ (۰٫۱، ۰٫۲، ۰٫۳ — با تاییدِ زنده‌ی دیتابیس).**
**بعدی: فاز ۱ — گام ۱٫۱، probeِ StrictMode. این دروازه است.**
...
**فاز ۱ — که دروازه است.** گام ۱٫۱: probeِ StrictMode ([ADR-028](ARCHITECTURE_DECISIONS.md#adr-028)).
تا سبز نشود، **هیچ خطی از binder نوشته نمی‌شود** — چون binder دقیقاً همان اشتراک‌هایی را
می‌بندد که در M1 زیر StrictMode مرده ماندند، و اگر مرده بمانند binder بی‌صدا هیچ تغییری
emit نمی‌کند. اگر probe شکست خورد، **در `canvas-core` دست نبر** — با گزینه‌ها و هزینه‌ی
هرکدام برگرد پیش مالک (قیدِ بالا؛ سه گزینه‌ی نامزد از قبل در گام ۱٫۱ فهرست شده‌اند).
