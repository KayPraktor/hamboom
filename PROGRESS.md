...
**گام فعلی: گام ۴٫۳ تقریباً کامل — نوار وضعیت/منو/پنل استایل/zoom تمام؛ فقط mini-map مانده (کم‌ضروری، قابل‌تعویق)**
پله‌ی [ADR-003](ARCHITECTURE_DECISIONS.md#adr-003): **A** (بسته npm، بدون patch)

**۴۸۵ تست سبز** (۴۴ shared-types، ۳۹۹ canvas-core، ۴۲ i18n). `typecheck` · `lint` ·
...
**تنها مانده در ۴٫۳: mini-map** — رندرِ سفارشی از مرزهای صحنه. طبق تصمیم مالک
**کم‌ضروری‌ترین برای MVP و قابلِ تعویق به فاز بعد**. منتظر تصمیم: تعویق (رفتن به ۴٫۴)
یا ساختِ همین‌جا.
