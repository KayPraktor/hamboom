...
- ⚠️ **پیشنهادِ فاز بعد (لمسِ M1ِ جدا، نیازِ تایید):** نوار ابزارِ **نیتیوِ excalidraw** هنوز کنارِ
      نوارِ ما دیده می‌شود؛ برای ظاهرِ «شبیه‌میرو» با `UIOptions`/zenMode روی `HamboomCanvas` پنهان شود.
