    ...
    <div className="card payment-result">
      {status === "ok" ? (
        ...
        <>
          ...
          <p>
            اگر مبلغی از حسابت کم شده، نگران نباش: تا ۷۲ ساعت به‌صورت خودکار بررسی می‌شود و اگر
            پرداخت واقعاً انجام شده باشد اشتراکت فعال می‌شود. وگرنه مبلغ به حسابت برمی‌گردد.
          </p>
        </>
      ) : (
        <>
          ...
          <p>
            این آدرس پارامترهای درستی نداشت. اگر پرداختی انجام داده‌ای، از صفحه‌ی پرداختِ تیم پیگیری
            کن.
          </p>
        </>
      )}
